...
$logPath = Join-Path $projectRoot "Logs\light-texture-scene-build.log"
...
$arguments = @(
    ...
    $logPath,
    "-executeMethod",
    "BellRinger.Debug.Editor.BellRingerLightTextureSceneBuilder.CreateLightTextureTestScene"
)
