...
$logPath = Join-Path $projectRoot "Logs\pad-tracking-scene-build.log"
...
$arguments = @(
    ...
    $logPath,
    "-executeMethod",
    "BellRinger.Debug.Editor.BellRingerPadTrackingTestSceneBuilder.CreatePadTrackingTestScene"
)
